...
from dots import listwrap
from parsing_future import text, Iterable
from imports import delay_import
...
from parsing.expressions import MatchFirst, Or
from parsing.results import ParseResults, NO_PARSER
...
from parsing.utils import regex_range, wrap_parse_action

Regex = delay_import("parsing.regex.Regex")
...
def infix_notation(
    ...
    :param spec: list of tuples, one for each operator precedence level
       ...
       - op_expr is the parsing expression for the operator; may also
       ...
       - rightLeftAssoc is the indicator whether the operator is right
         or left associative, using the parsing-defined constants
