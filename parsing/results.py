...
from dots import is_many, is_null
from parsing_future import is_text, text, zip_longest, MutableMapping
from imports import expect, export

from parsing.utils import Log, listwrap
...
class ParseResults(object):
    ...
    def as_list(self):
        ...
        Example::
            ...
            # even though the result prints in string-like form, it is actually a parsing ParseResults
            print(type(result), result) # -> <class 'parsing.ParseResults'> ['sldkj', 'lsdkj', 'sldkj']
...
from parsing import utils, whitespaces

utils.register_type(ParseResults)

export("parsing.utils", ParseResults)
