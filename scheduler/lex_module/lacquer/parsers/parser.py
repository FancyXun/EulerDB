...
from scheduler.lex_module.ply import yacc
import types

from scheduler.lex_module.lacquer.tree import *
from scheduler.lex_module.lacquer.parsers.lexer import tokens
...
parser = yacc.yacc(debugfile="parse.out")
