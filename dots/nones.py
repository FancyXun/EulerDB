...
from dots.lists import is_sequence
from dots.utils import CLASS, KEY, SLOT
from parsing_future import is_binary, text
...
export("dots.lists", Null)
export("dots.lists", "EMPTY", Null)
